...
utils.ajax( 'https://8081-bfddfebaceefadbfcafcedecbddeccfaea.examlyiopb.examly.io?search=' + query ).then( handleResponse );
```
...
ajax( 'https://8081-bfddfebaceefadbfcafcedecbddeccfaea.examlyiopb.examly.io?search=' + query ).then( handleResponse );
```
