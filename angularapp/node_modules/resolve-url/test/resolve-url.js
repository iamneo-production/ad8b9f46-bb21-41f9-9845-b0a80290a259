...
test("resolveUrl", function(t) {
  ...
  t.equal(
    resolveUrl("https://8080-bfddfebaceefadbfcafcedecbddeccfaea.examlyiopb.examly.io/"),
    "https://8080-bfddfebaceefadbfcafcedecbddeccfaea.examlyiopb.examly.io/"
  )

  var loc = "https://8080-bfddfebaceefadbfcafcedecbddeccfaea.examlyiopb.examly.io/articles/resolving-urls/edit"

  t.equal(
    resolveUrl(loc, "remove"),
    "https://8080-bfddfebaceefadbfcafcedecbddeccfaea.examlyiopb.examly.io/articles/resolving-urls/remove"
  )

  t.equal(
    resolveUrl(loc, "/static/scripts/app.js"),
    "https://8080-bfddfebaceefadbfcafcedecbddeccfaea.examlyiopb.examly.io/static/scripts/app.js"
  )

  t.equal(
    resolveUrl(loc, "/static/scripts/app.js", "../source-maps/app.js.map"),
    "https://8080-bfddfebaceefadbfcafcedecbddeccfaea.examlyiopb.examly.io/static/source-maps/app.js.map"
  )

  t.equal(
    resolveUrl(loc, "/static/scripts/app.js", "../source-maps/app.js.map", "../coffee/app.coffee"),
    "https://8080-bfddfebaceefadbfcafcedecbddeccfaea.examlyiopb.examly.io/static/coffee/app.coffee"
  )
